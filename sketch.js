...
Pc.addAnimation("Blindado",Titan_Blindado);
...
if(estado === "Fase2"){
    ...
    jogador.scale = 0.2;
    Pc.changeAnimation("Blindado",Titan_Blindado);
    Pc.scale = 0.08;
    Pc.velocityX = Math.round(random(-8,8));
    Pc.velocityY = Math.round(random(-8,8));
    Pc.bounceOff(Grupoparede2);
}
